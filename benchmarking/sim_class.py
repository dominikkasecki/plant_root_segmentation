...
class Simulation:
    def __init__(self, num_agents, render=True, rgb_array=False):
        ...
        print('This is texture list', texture_list)
        random_texture = random.choice(texture_list[:-1])
        # random_texture = '06.png'
        print('This is a random texture ', random_texture)
        ...
        cameraTargetPosition = [-0.2, -(math.ceil(num_agents ** 0.5) / 2) + 0.5,
                                0.1]  # XYZ coordinates of the target position
    ...
    def run(self, actions, num_steps=1):
        ...
        for i in range(num_steps):
            ...
            if self.rgb_array:
                ...
                # Get camera image
                width, height, rgbImg, depthImg, segImg = p.getCameraImage(width=320, height=240,
                                                                           viewMatrix=p.computeViewMatrix(camera_pos,
                                                                                                          camera_target,
                                                                                                          up_vector),
    ...
    def drop(self, robotId):
        ...
        sphereBody = p.createMultiBody(baseMass=0.1, baseVisualShapeIndex=visualShapeId,
